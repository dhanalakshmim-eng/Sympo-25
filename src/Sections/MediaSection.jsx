...
const MediaSection = () => {
  ...
  return (
    <div className="flex flex-col items-start">
      <h1 className="media-heading text-xl sm:text-1xl md:text-2xl lg:text-2xl xl:text-2xl text-center text-[#ff00cc] bg-gradient-to-br from-[#fc03e3] to-[#a6033c] bg-clip-text text-transparent font-sans font-semibold py-4 px-4 ">
