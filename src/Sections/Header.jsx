  ...
  <div className="max-w-screen-xl flex items-center justify-between mx-auto p-2">
    <a href="/" className="flex items-center">
      <img
        ...
        className="w-10 h-10 sm:w-22 sm:h-10 md:w-22 md:h-20 lg:w-24 lg:h-16 xl:w-26 xl:h-20 object-cover"
      />
    </a>
            ...
            >
              {!isMenuOpen ? (
                <path
                  ...
                  17.7-14.3 32-32 32L32 448c-17.7 
                  0-32-14.3-32-32s14.3-32 32-32l384 0c17.7 
                  0 32 14.3 32 32z"
                />
              ) : (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                  <path
                    ...
                    12.5 45.3 0L192 301.3 297.4 
                    406.6c12.5 12.5 32.8 12.5 45.3 
                    0s12.5-32.8 0-45.3L237.3 
                    256 342.6 150.6z"
                  />
                </svg>
              )}
          ...
          <div
            className={`${
              isMenuOpen
                ...
                : "hidden animate__animated animate__fadeInDown"
            ...
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 text-2xl rounded-lg bg-transparent md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
              <li>
                <Link
                  ...
                  bg-gradient-to-r from-pink-500 to-red-500 text-white font-bold rounded-full shadow-lg 
