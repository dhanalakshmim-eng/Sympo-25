  ...
  return (
    <div className="text-center p-4 sm:p-6 md:p-8 lg:p-6 xl:p-6">
      <p className=" clg-font  bg-blue-200 text-3xl sm:text-2xl md:text-3xl lg:text-5xl   font-extrabold mb-0 bg-white bg-clip-text text-transparent font-otherfont animate__animated animate__fadeInUp duration-500">
        ...
        <span className="clg-font  bg-blue-200  text-1xl sm:text-1xl md:text-2xl lg:text-3xl font-extrabold bg-white bg-clip-text text-transparent font-otherfont animate__animated animate__fadeInUp duration-500">AN AUTONOMOUS INSTITUTION</span>
        ...
        <span className="clg-font  bg-blue-200  text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold bg-white bg-clip-text text-transparent font-otherfont animate__animated animate__fadeInUp duration-500">PRESENTS</span> <br /> <br />
      </p>
